...
from flow_3d.workspace import Workspace
...
class PortfolioWorkspace:
    ...
    def workspace_initialize(self, name = None, portfolio_path = None, **kwargs):
        """
        ...
        workspace_path = workspace.workspace_initialize(portfolio_path, **kwargs)
